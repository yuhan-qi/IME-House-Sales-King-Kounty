...
train_label = kc_house_truc[1:numberOfTrainingSamples,13]
test_data = kc_house_truc[-(1:numberOfTrainingSamples),2:12]
test_label = kc_house_truc[-(1:numberOfTrainingSamples),13]
...
params <- list(booster = "gbtree", objective = "reg:linear", 
               eta=0.1, max_depth=5, colsample_bytree=0.5, subsample=1.0)
...
#Hypothesis 1 - grade
PDP_1_price_per_sqft_living_non_centered <- partial(bst_model, pred.var = "grade", ice = TRUE, center = FALSE, 
                                                    plot = TRUE, rug = TRUE,  plot.engine = "ggplot2",
                                                    train = train_data)
PDP_1_price_per_sqft_living_centered <- partial(bst_model, pred.var = "grade", ice = TRUE, center = TRUE, 
                                                plot = TRUE, rug = TRUE,  plot.engine = "ggplot2",
                                                train = train_data)

#Hypothesis 2 - yr_built
PDP_2_price_per_sqft_living_non_centered <- partial(bst_model, pred.var = "yr_built", ice = TRUE, center = FALSE, 
                                                    plot = TRUE, rug = TRUE,  plot.engine = "ggplot2",
                                                    train = train_data)
PDP_2_price_per_sqft_living_centered <- partial(bst_model, pred.var = "yr_built", ice = TRUE, center = TRUE, 
                                                plot = TRUE, rug = TRUE,  plot.engine = "ggplot2",
                                                train = train_data)

#Hypothesis 3 - condition
PDP_3_price_per_sqft_living_non_centered <- partial(bst_model, pred.var = "condition", ice = TRUE, center = FALSE, 
                                                    plot = TRUE, rug = TRUE,  plot.engine = "ggplot2",
                                                    train = train_data)
PDP_3_price_per_sqft_living_centered <- partial(bst_model, pred.var = "condition", ice = TRUE, center = TRUE, 
                                                plot = TRUE, rug = TRUE,  plot.engine = "ggplot2",
                                                train = train_data)


#Hypothesis 4 - floors
PDP_1_price_per_sqft_living_non_centered <- partial(bst_model, pred.var = "floors", ice = TRUE, center = FALSE, 
                                    plot = TRUE, rug = TRUE,  plot.engine = "ggplot2",
                                    train = train_data)
PDP_1_price_per_sqft_living_centered <- partial(bst_model, pred.var = "floors", ice = TRUE, center = TRUE, 
                                plot = TRUE, rug = TRUE,  plot.engine = "ggplot2",
                                train = train_data)


#Hypothesis 5 - sqft_lot
PDP_2_price_per_sqft_living_non_centered <- partial(bst_model, pred.var = "sqft_lot", ice = TRUE, center = FALSE, 
                              plot = TRUE, rug = TRUE,  plot.engine = "ggplot2",
                              train = train_data)
PDP_2_price_per_sqft_living_centered <- partial(bst_model, pred.var = "sqft_lot", ice = TRUE, center = TRUE, 
                          plot = TRUE, rug = TRUE,  plot.engine = "ggplot2",
                          train = train_data)
